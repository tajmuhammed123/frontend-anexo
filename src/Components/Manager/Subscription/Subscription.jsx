  ...
  export function Subscription() {
    ...
    const handleSubscribe=async(name)=>{
      ...
      const managerInfo=JSON.parse(managerData)
        ...
        const res=await axiosManagerInstance.get(`/handlesubscription/${managerInfo.user._id}`,config)
        if(res.data.status){
    ...
    return (
      ...
      <Card color="green" variant="gradient" className="w-full max-w-[17rem] p-8 m-5 h-fit">
        <CardHeader
          floated={false}
          shadow={false}
          color="transparent"
      ...
      <Card color="red" variant="gradient" className="w-full max-w-[17rem] p-8 m-5 h-fit">
        <CardHeader
          floated={false}
          shadow={false}
          color="transparent"
      ...
      <Card color="gray" variant="gradient" className="w-full max-w-[17rem] p-8 m-5 h-fit">
        <CardHeader
          floated={false}
          shadow={false}
          color="transparent"
