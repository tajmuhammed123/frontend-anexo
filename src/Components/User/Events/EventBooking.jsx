...
function EventBooking() {
  ...
  const handleSubmit = async (e) => {
    ...
    if(response.status){
      if (response.user.is_paid) {
          ...
          GenerateSuccess("Your Event Booking Saved, Pay your Initial Payment");
          setTimeout(() => {
            navigate(`/payment`);
          }, 2000);
        }
  ...
  const changeDate = (e) => {
    ...
    if (dateIndex === -1) {
      ...
      setEventData((prevEventData) => ({
        ...prevEventData,
        date: prevEventData.date.filter(
    ...
    <div className="">
      <div className="flex justify-center items-center">
        <div>
          <Card
            color="transparent"
            className="m-0 grid place-items-center shadow-lg rounded-b-none py-8 px-4 text-center"
            floated={false}
            shadow={false}
          ...
          >
            ...
            <form
              className="mt-8 mb-2 w-400 max-w-screen-lg sm:w-200"
            ...
            >
              <div className="mb-4 flex flex-col gap-6">
                ...
                <div className="flex flex-wrap w-full">
                  <Input
                    size="lg"
                    label="Preffered Dishes"
                    name="preffered_dishes"
                    onChange={(e) =>
                      setEventData({
                        ...eventdata,
                        [e.target.name]: e.target.value,
                ...
                <div className="flex flex-row gap-2 justify-center">
                  <Calendar
                    ...
                    tileContent={({ date, view }) => {
                      if (
                        view === "month" &&
                        eventdata.date.some((selectedDate) =>
