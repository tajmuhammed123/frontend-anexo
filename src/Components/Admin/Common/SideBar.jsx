...
export function Sidebar({ closeSidebar }) {
  ...
  const handleLogOut = async () => {
    dispatch(AdminLogoutDetails());
    navigate("/admin/login");
  };

  return (
    <List>
      <ListItem onClick={() => (navigate("/admin/dashboard"), closeSidebar())}>
        <ListItemPrefix>
          <svg
      ...
      <ListItem onClick={() => (navigate("/admin/userdata"), closeSidebar())}>
        <ListItemPrefix>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
      ...
      <ListItem
        onClick={() => (navigate("/admin/eventcategorey"), closeSidebar())}
      >
        <ListItemPrefix>
          <svg
            xmlns="http://www.w3.org/2000/svg"
