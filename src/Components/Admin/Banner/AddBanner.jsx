...
function AddBanner() {
  ...
  const { isLoading, error } = useQuery({
    queryKey: ["bannerdata"],
    queryFn: () =>
      axiosAdminInstance.get(`/getbannerdata/${id}`).then((res) => {
        (initialValues.banner_text = res.data.banner
          ? res.data.banner.banner_text
          : ""),
          (initialValues.main_text = res.data.banner
            ? res.data.banner.main_text
            : ""),
