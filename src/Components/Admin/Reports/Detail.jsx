  ...
  export function Detail() {
    ...
    const getReportData=async()=>{
        try {
            ...
            const response = await axiosAdminInstance.get(`/reportdetails/${id}`,config);
    ...
    const handleReject=async()=>{
        ...
        let response=await axiosAdminInstance.post('/managerreject',{id},config)
    ...
    return (
      ...
      {data.map((item,index)=>(<><Card className="mt-6 w-96 m-5">
        <CardBody>
          {/* <svg
